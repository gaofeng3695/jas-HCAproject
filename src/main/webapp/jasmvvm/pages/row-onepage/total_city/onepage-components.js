...
Vue.component('jas-onepage-wrapper', { //value 值 支持逗号分隔 的多选下拉框
  ...
  template: [
    ...
    '		<div style="background: #f9000000 url(image/title2.png) no-repeat top center;height: 100%">',
    ...
    '		</div>',
    '	</div>',
    ' <div v-show="pptshowed" style="width:100%;height:100%;position: fixed;top:0;left:0;z-index: 9999;background:#00000080;">',
