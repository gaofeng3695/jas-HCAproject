...
public class DaqDetectionInfiltrationDao extends BaseNamedParameterJdbcDao{
	 ...
	 * <p>功能描述：获取单个对象。</p>
	  ...
	  * @return
	  * @since JDK1.8。
	  * <p>创建日期:2018年8月21日 下午4:21:15。</p>
	  * <p>更新日期:[日期YYYY-MM-DD][更改人姓名][变更描述]。</p>
	 */
	public DaqDetectionInfiltration find(String oid) {
		String sql = "select * from daq_detection_infiltration t where t.oid=?";
		List<DaqDetectionInfiltration> data = baseJdbcTemplate.queryForList(sql, new Object[]{oid}, DaqDetectionInfiltration.class);
	 ...
	 * @param i
	 * @since JDK1.8。
	 * <p>创建日期:2018年8月21日 下午4:09:21。</p>
	 * <p>更新日期:[日期YYYY-MM-DD][更改人姓名][变更描述]。</p>
	 */
	public void chanageWledStatus(String weldOid, int status) {
		String sql = "update daq_construction_weld set is_infiltration="+status+" where oid='"+weldOid+"';"
				+ "update daq_weld_rework_weld set is_infiltration="+status+" where oid='"+weldOid+"';";
