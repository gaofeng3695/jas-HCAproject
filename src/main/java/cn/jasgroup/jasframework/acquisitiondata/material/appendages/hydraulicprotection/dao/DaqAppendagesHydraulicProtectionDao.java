package cn.jasgroup.jasframework.acquisitiondata.material.appendages.hydraulicprotection.dao;
 ...
 * @description 水工保护
 * @author zhangyi
 * @date 2018年7月21日下午1:59:20
 * @version V1.0
 * @since JDK 1.80
 */

@Component
public class DaqAppendagesHydraulicProtectionDao extends BaseNamedParameterJdbcDao {
	...
	public DaqAppendagesHydraulicProtectionBo get(BaseJavaQuery query){
		...
		return (DaqAppendagesHydraulicProtectionBo) this.baseJdbcDao.queryForObject(sql, 
				new Object[]{query.getOid()}, DaqAppendagesHydraulicProtectionBo.class);
	}
