package cn.jasgroup.jasframework.acquisitiondata.material.appendages.obstacle.dao;
 ...
 * @description 地下障碍物
 * @author zhangyi
 * @date 2018年7月21日下午12:58:25
 * @version V1.0
 * @since JDK 1.80
 */

@Component
public class DaqAppendagesObstacleDao extends BaseNamedParameterJdbcDao {
	...
	public Boolean approve(Map<String, Object> paramMap) {
		Boolean b = false;
		String sql = "update daq_appendages_obstacle set approve_status = :approveStatus  where active=1"
				+ " and oid in (:idList)";
	...
	public DaqAppendagesObstacleBo get(BaseJavaQuery query){
		...
		return (DaqAppendagesObstacleBo) this.baseJdbcDao.queryForObject(sql, 
				new Object[]{query.getOid()}, DaqAppendagesObstacleBo.class);
	}
}
