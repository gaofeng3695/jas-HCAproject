...
@Component
public class DaqCrossBoxCulvertDao extends BaseNamedParameterJdbcDao {
	 ...
	 * <p>功能描述：数据审核。</p>
	 * <p>张毅 </p>	
	 * @param paramMap key 为idList, approveStatus
	 * @return
	 * @since JDK1.8。
	...
	public Boolean approve(Map<String, Object> paramMap) {
		Boolean b = false;
		String sql = "update daq_cross_box_culvert set approve_status = :approveStatus where active=1"
				+ " and oid in (:idList)";
