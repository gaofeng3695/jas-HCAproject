package cn.jasgroup.jasframework.acquisitiondata.material.cross.across.query.bo;
 ...
 * @description 跨越表
 * @author zhangyi
 * @date 2018年7月17日上午11:02:16
 * @version V1.0
 * @since JDK 1.80
 */

public class DaqCrossAcrossBo extends CommonBaseBo {
	...
	public String getAcrossTypeName() {
		return acrossTypeName;
	}

	public void setAcrossTypeName(String acrossTypeName) {
		this.acrossTypeName = acrossTypeName;
	}
