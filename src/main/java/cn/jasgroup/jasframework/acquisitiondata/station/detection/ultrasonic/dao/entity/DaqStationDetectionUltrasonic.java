 ...
 * @version v1.0.0.1。
 * @since JDK1.8.0_181。
 * <p>创建日期：2019-01-14 10:00:31。</p>
 */
@CommonSaveConfig(scene = "/stationDetectionUltrasonic/save")
@CommonUpdateConfig(scene = "/stationDetectionUltrasonic/update")
@CommonDeleteConfig(scene = "/stationDetectionUltrasonic/delete")
@CommonDeleteBatchConfig(scene = "/stationDetectionUltrasonic/deleteBatch")
@CommonGetConfig(scene = "/stationDetectionUltrasonic/get")
@UniqueConstraints(
    strategys ={
...
@JdbcEntity(name="daq_station_detection_ultrasonic")
public class DaqStationDetectionUltrasonic extends CommonJdbcEntity {
    ...
    /** 子表集合 */
    private List<DaqStationDetectionUltrasonicSub> stationDetectionUltrasonicSubList = new ArrayList<DaqStationDetectionUltrasonicSub>();
    ...
    public List<DaqStationDetectionUltrasonicSub> getStationDetectionUltrasonicSubList() {
        return stationDetectionUltrasonicSubList;
    }

    public void setStationDetectionUltrasonicSubList(List<DaqStationDetectionUltrasonicSub> stationDetectionUltrasonicSubList) {
