package cn.jasgroup.jasframework.acquisitiondata.mesolow.strideacrossinfo.query;

import cn.jasgroup.jasframework.acquisitiondata.mesolow.strideacrossinfo.query.bo.DaqMvStrideAcrossInfoBo;
 ...
 * @version v1.0.0.1。
 * @since JDK1.8。
 * <p>创建日期：2019年01月25日 11:08。</p>
 */
@QueryConfig(
        scene ="/daqMvStrideAcrossInfo/getPage",
        resultClass= DaqMvStrideAcrossInfoBo.class,
        queryBeforeProcess = {
                @Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
        }
)
public class DaqMvStrideAcrossInfoQuery extends BaseJavaQuery {
    ...
    public String getQuerySql() {
        ...
        bufferSql.append("select wc.* ,pro.project_name,pu.unit_name as supervision_unit_name,u.unit_name as construct_unit_name,mpn.pipe_node_code start_pipe_node_name,mpn1.pipe_node_code end_pipe_node_name, " +
                ...
                "from daq_mv_stride_across_info wc " +
